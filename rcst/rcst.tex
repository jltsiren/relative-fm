...
Table~\ref{table:construction}: Index construction time/space, LCS lengths. Note that basic RFM is much better optimized and parallelized. Note that relative index construction assumes that the corresponding FM-indexes and LCP arrays already exist. Note: DLCP indexing time!
