...
\title{Relative Suffix Trees\thanks{This work is funded in part by:
Basal Funds FB0001, Conicyt, Chile;
...
\author{
Andrea Farruggia\inst{1}
\and
Travis Gagie\inst{2,3}
\and
Gonzalo Navarro\inst{2,4} 
\and
Simon J. Puglisi\inst{5}
\and
Jouni Sir\'en\inst{6}
}
...
\institute{
    ...
    University of Pisa,
    Italy.
    \email{a.farruggia@di.unipi.it}\\[1ex]
\and
    CeBiB -- Center for Biotechnology and Bioengineering, Chile\\[1ex]
\and
