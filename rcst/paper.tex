...
suffix tree, while using several times more space than a compressed
representation of the sequence.
In this work, we take a new approach to compressed suffix trees for repetitive
sequence collections, such as collections of individual genomes. When the
individual sequences are similar, their suffix trees should also be similar.
We compress the individual suffix trees relative to the suffix tree of a
reference sequence. These relative compressed suffix trees provide competitive
...
fastest compressed suffix trees. Unlike the existing compressed suffix trees
for repetitive collections, our relative compressed suffix trees provide
access to the suffix trees of individual sequences.
\end{abstract}
